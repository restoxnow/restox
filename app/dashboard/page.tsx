...
const STATS = [
  { label: 'Active Schedules',    value: '0',  icon: Clock,      bg: 'bg-blue-50 dark:bg-blue-900/30',         color: 'text-blue-600 dark:text-blue-400',   href: '/dashboard/schedules' },
  { label: 'Connected Retailers', value: '0',  icon: Store,      bg: 'bg-rx-orange-light dark:bg-rx-orange/10', color: 'text-rx-orange',                     href: '/dashboard/retailers' },
  { label: 'Products Tracked',    value: '0',  icon: Package,    bg: 'bg-purple-50 dark:bg-purple-900/30',     color: 'text-purple-600 dark:text-purple-400', href: '/dashboard/products' },
  { label: 'Saved This Month',    value: '$0', icon: DollarSign, bg: 'bg-green-50 dark:bg-green-900/30',       color: 'text-green-600 dark:text-green-400',  href: null },
]
    ...
    <div className="max-w-5xl mx-auto space-y-6">
        ...
        {STATS.map(({ label, value, icon: Icon, bg, color, href }) => {
          const card = (
            <div className={`bg-white dark:bg-[#16213E] rounded-xl p-4 border border-gray-100 dark:border-white/10 shadow-sm dark:shadow-none h-full
              ...
              <p className="text-2xl font-heading font-bold text-rx-navy dark:text-white">{value}</p>
      ...
      <div className="bg-white dark:bg-[#16213E] rounded-xl border border-gray-100 dark:border-white/10 shadow-sm dark:shadow-none">
        ...
        <div className="py-12 flex flex-col items-center text-center px-6">
          ...
          <p className="text-sm font-medium text-rx-navy dark:text-white font-body mb-1">No upcoming orders</p>
